...
public class RxRegUtils {
    ...
    public static boolean isMobileSimple(String string) {
        return isMatch(RxConstUtils.REGEX_MOBILE_SIMPLE, string);
    }
    ...
    public static boolean isMobileExact(String string) {
        return isMatch(RxConstUtils.REGEX_MOBILE_EXACT, string);
    }
    ...
    public static boolean isTel(String string) {
        return isMatch(RxConstUtils.REGEX_TEL, string);
    }
    ...
    public static boolean isIDCard15(String string) {
        return isMatch(RxConstUtils.REGEX_IDCARD15, string);
    }
    ...
    public static boolean isIDCard18(String string) {
        return isMatch(RxConstUtils.REGEX_IDCARD18, string);
    }
    ...
    public static boolean isIDCard(String string) {
        return isMatch(RxConstUtils.REGEX_IDCARD, string);
    }
    ...
    public static boolean isEmail(String string) {
        return isMatch(RxConstUtils.REGEX_EMAIL, string);
    }
    ...
    public static boolean isURL(String string) {
        return isMatch(RxConstUtils.REGEX_URL, string);
    }
    ...
    public static boolean isChz(String string) {
        return isMatch(RxConstUtils.REGEX_CHZ, string);
    }
    ...
    public static boolean isUsername(String string) {
        return isMatch(RxConstUtils.REGEX_USERNAME, string);
    }
    ...
    public static boolean isDate(String string) {
        return isMatch(RxConstUtils.REGEX_DATE, string);
    }
    ...
    public static boolean isIP(String string) {
        return isMatch(RxConstUtils.REGEX_IP, string);
    }
    ...
    public static boolean isMatch(String regex, String string) {
        return !RxDataUtils.isNullString(string) && Pattern.matches(regex, string);
    }
