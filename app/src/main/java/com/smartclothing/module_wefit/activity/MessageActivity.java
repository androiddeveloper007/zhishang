...
public class MessageActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        fragmentLessen.setOnReadStateChangedListener(new MessagePagerItemFragment.readStateChangedListener() {
            ...
            public void allReadState(boolean isAllRead) {
                if(isAllRead) {
                    ...
                    tv_right_commit.setTextColor(getResources().getColor(R.color.title_right_color));
    ...
    private void readAllRequest(final int msgType) {
        ...
        RxManager.getInstance().doNetSubscribe(dxyService.readedAll("c82e9e7612a447358c2a82ef437f3d11", msgType))
