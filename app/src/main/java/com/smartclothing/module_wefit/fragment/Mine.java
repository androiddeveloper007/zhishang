...
public class Mine extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_mine_set:
                ...
                break;
            case R.id.ll_iv_mine_msg:
                startActivity(new Intent(getContext(), MessageActivity.class));
                break;
            case R.id.ll_diet_record:
                break;
            case R.id.ll_sport_record:
                break;
    ...
    private void initData() {
        ...
        RxManager.getInstance().doNetSubscribe(dxyService.userCenter(body))
                ...
                .subscribe(new RxNetSubscriber<String>() {
                    ...
                    protected void _onNext(String s) {
                        ...
                        UserCenterBean user = gson.fromJson(s,
                                new TypeToken<UserCenterBean>() {}.getType());
